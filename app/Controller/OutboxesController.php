    ...
    class OutboxesController extends AppController
    {
        ...
        public function beforeFilter()
        {
            ...
            */
            ...
            $this->set( compact( 'var_model', 'module_title', 'module_desc', 'title_for_layout', 'module_icon', 'mail_types' ) );            
        ...
        public function admin_add()
        {
            ...
            $data  = $this->Outbox->find( 'first', array( 'fields' => array( 'no_arsip' ), 'order' => 'Outbox.id DESC', 'conditions' => array( 'Outbox.created LIKE ' => date('Y-m-d').'%' ) ) );
