...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <br />
            ...
            <?php
                    $row = $this->request->data[ 'Page' ];
                    $id             = $row[ 'id' ];
                    $picture_dir    = '/files/page/image/' . $id . '/';
                    $picture        = $picture_dir . '' . $row[ 'image' ];
                    $thumb          = $picture_dir . 'thumb_' . $row[ 'image' ];
            ?>            
            <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo __( 'Current Image' ); ?></label>
                <div class="col-sm-10">
