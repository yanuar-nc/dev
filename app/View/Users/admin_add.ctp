...
<div class="panel panel-default">
    ...
    <?php echo $this->Form->create( $var_model, array( 'action' => ACTION_ADD, 'type' => 'file', 'autocomplete' => 'off', 'class' => 'form-horizontal', 'inputDefaults' => array( 'div' => false, 'label' => false ) ) ); ?>  
    ...
    <div class="panel-body">
        ...
        <br />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Form->input( 'password', array( 'class' => 'form-control', 'maxlength' => 16, 'class' => 'form-control', 'placeholder' => __( 'New Password' ), 'type' => 'password'  ) ); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Form->input( 'rpassword', array( 'class' => 'form-control', 'maxlength' => 16, 'class' => 'form-control', 'placeholder' => __( 'Re-type Password' ), 'type' => 'password'  ) ); ?>
                </div>
            </div>
