    ...
    ?>
        <div class="row">
            <div class="col-sm-12 mb30">
                <p>Pesan ketua: </p>
                <?= $this->Form->input( 'MailInbox.Assistant', array( 'options' => $leader_assistants, 'multiple' => 'checkbox', 'class' => 'checkbox block', 'disabled' ) ); ?>
                <?= $this->Form->input( 'message_leader', array( 'required', 'class' => 'form-control', 'disabled'  ) );
                ?>
            </div>
            <div class="col-sm-12 mb30">
